...
Each solutions contains several projects(which are microservices from the view of Docker). **Before you run or view each solutions, don't forget to browse Readme.md in it for matters and attention.**
